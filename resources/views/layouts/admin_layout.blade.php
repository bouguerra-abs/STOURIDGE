                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('admin.services.create') }}"><span class="mr-2"><i class="fas fa-plus-circle"></i></span> Create</a>
                                    <a class="nav-link" href="{{ route('admin.services.list') }}"><span class="mr-2"><i class="fas fa-list"></i></span> List</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('admin.portfolios.create') }}"><span class="mr-2"><i class="fas fa-plus-circle"></i></span> Create</a>
                                    <a class="nav-link" href="{{ route('admin.portfolios.list') }}"><span class="mr-2"><i class="fas fa-list"></i></span> List</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('admin.abouts.create') }}"><span class="mr-2"><i class="fas fa-plus-circle"></i></span> Create</a>
                                    <a class="nav-link" href="{{ route('admin.abouts.list') }}"><span class="mr-2"><i class="fas fa-list"></i></span> List</a>
                                </nav>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright <strong>{{ config('app.name') }}</strong> &copy; <?php echo date("Y"); ?>. All Rights Reserved</div>
                            <div>
